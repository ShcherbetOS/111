...
define('EMAIL_SETTINGS', [
  'addresses' => ['msherbatyuck@gmail.com'], // кому необходимо отправить письмо
  'from' => ['msherbatyuck@gmail.com', 'Дом Мебели admin'], // от какого email и имени необходимо отправить письмо
